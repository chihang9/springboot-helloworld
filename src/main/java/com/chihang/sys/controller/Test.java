...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        String content = "GhsGhsbEBdXSgcNARAMCkoCDQ==";
        String password = "zfDZlUdHWuTAERFE8IP+K9LM8Vd9G691lACc7RXI+KM=";
        System.out.println("明文：" + content);
        System.out.println("key：" + password);

        byte[] encryptResult = encryptResult =Base64.encode(content.getBytes());
        //System.out.println("密文：" + Test.parseByte2HexStr(encryptResult));

        String decryptResult = Test.decrypt(encryptResult, password);
